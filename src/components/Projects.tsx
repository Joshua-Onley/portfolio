            ...
            {projects.map((project, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <span className="px-2 py-1 bg-secondary/20 text-secondary text-xs rounded-md font-medium">
                    {project.status}
                  </span>
                </div>
                ...
                {project.grade && <p className="text-sm font-medium text-accent mb-4">{project.grade}</p>}
